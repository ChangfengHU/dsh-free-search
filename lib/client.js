window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      ".dshfs-updatePill{display:inline-flex;align-items:center;gap:4px;border:0;background:transparent;color:var(--dsw-alias-state-business-primary);font:inherit;font-size:12px;font-weight:500;cursor:pointer;padding:3px 6px;border-radius:6px;text-decoration:none;transition:background-color .13s}",
      ".dshfs-updatePill:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-accent)}",
                                      ...
                                      updateInfo.installable
                                        ? react_jsx_runtime.jsx("button", {
                                            ...
                                            children: [
                                              ...
                                              upgrading ? t.upgrading : t.hasUpdate,
                                            ],
                                          })
                                        : react_jsx_runtime.jsx("a", {
                                            className: "dshfs-updatePill",
